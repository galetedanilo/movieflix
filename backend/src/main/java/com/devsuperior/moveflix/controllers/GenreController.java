...
import com.devsuperior.moveflix.services.GenreService;
...
public class GenreController implements Serializable {
	...
	@PostMapping
	public ResponseEntity<GenreDTO> insert(@Validated @RequestBody GenreDTO dto) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<GenreDTO> update(@PathVariable Long id, @Validated @RequestBody GenreDTO dto) {
